...
\spl_autoload_register('\WordPress\Plugin\EveOnlineTranquilityStatus\autoload');

function autoload($className) {
	// If the specified $className does not include our namespace, duck out.
	if(\strpos($className, 'WordPress\Plugin\EveOnlineTranquilityStatus') === false) {
		return;
	} // END if(\strpos($className, 'WordPress\Plugin\EveOnlineTranquilityStatus') === false)
